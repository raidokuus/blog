...
--
-- Host: localhost
-- Generation Time: Jan 27, 2014 at 11:45 AM
...
(1, 'Blogi', 'See on Raido blogi.\r\nMati on sõber', '2014-01-27 09:20:03', 1),
(2, 'Postitus', 'See on äge.', '2014-01-27 09:20:03', 1);
...
('root', '[{"db":"blog","table":"post"},{"db":"phpmyadmin","table":"pma_column_info"},{"db":"phpmyadmin","table":"pma_designer_coords"},{"db":"phpmyadmin","table":"pma_history"},{"db":"phpmyadmin","table":"pma_pdf_pages"},{"db":"phpmyadmin","table":"pma_recent"},{"db":"phpmyadmin","table":"pma_relation"},{"db":"cdcol","table":"cds"},{"db":"mysql","table":"user"},{"db":"mysql","table":"help_relation"}]');
...
('blog', 'post', 'user_id', 'blog', 'user', 'user_id');
...
('root', '2014-01-27 08:06:29', '{"lang":"et"}');
